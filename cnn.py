...
# define model
def build_cnn_model(time_steps, features_count):
...
# training
if not bload_model:
    cnn_lstm = build_cnn_model(time_steps,len(features))
    cnn_lstm.summary()
    ...
    cnn_lstm.save('cnn_test_2_128.keras')
else:
    cnn_lstm = load_model('cnn_test_2_128.keras', compile=False)
...
if test_importance:
    ...
    output_filename_a = 'feature_importance_cnn_permutation.csv'
...
# ====================
output_compare_path = r"F:\uqstudy\project\code\electricity_usage_monitoring\test\HTE_data\cnn_prediction_comparison_with_label.csv"
