...
# training
if not bload_model:
    cnn_lstm = build_lstm_model(time_steps,len(features))
    cnn_lstm.summary()
    ...
    cnn_lstm.save('cnn_lstm_128_40.keras')
else:
    cnn_lstm = load_model('cnn_lstm_128_40.keras', compile=False)
...
# ====================
output_compare_path = r"F:\uqstudy\project\code\electricity_usage_monitoring\test\HTE_data\final\cnn_lstm_prediction_comparison_with_label.csv"
